...
var UpdateEducationLevel = function UpdateEducationLevel(id, update, callback) {
    _classCallCheck(this, UpdateEducationLevel);

    _EducationLevel2.default.update({ _id: id }, update, function (err, result) {
        if (err) {
...
exports.default = UpdateEducationLevel;